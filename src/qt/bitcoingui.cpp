...
{
    resize(850, 550);
    setWindowTitle(tr("ROCK WORLD BI") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a ROCK WORLD BI address"));
...
//    charityAction = new QAction(QIcon(":/icons/charity"), tr("&Charity"), this);
//    charityAction->setToolTip(tr("慈善众筹"));
//    charityAction->setStatusTip(charityAction->toolTip());
//    charityAction->setCheckable(true);
//    charityAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
//    tabGroup->addAction(charityAction);
//    connect(charityAction , SIGNAL(triggered()), this, SLOT(gotoOverviewPage()));
//
//    chatAction = new QAction(QIcon(":/icons/chat"), tr("&Chat"), this);
//    chatAction->setToolTip(tr("聊吧"));
//    chatAction->setStatusTip(chatAction->toolTip());
//    chatAction->setCheckable(true);
//    chatAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
//    chatAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_7));
//    tabGroup->addAction(chatAction);
//    connect(chatAction , SIGNAL(triggered()), this, SLOT(gotoOverviewPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About ROCK WORLD BI"), this);
    aboutAction->setToolTip(tr("Show information about ROCK WORLD BI"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for ROCK WORLD BI"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ROCK WORLD BI client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ROCK WORLD BI client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ROCK WORLD BI network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ROCK WORLD BI address or malformed URI parameters."));
    }
