...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ROCK WORLD BI " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][6] = {
    {"node1", "118.178.241.38"},
    {"node2", "112.74.127.106"},
    {"node3", "120.76.138.7"},
    {"node4", "115.28.186.91"},
    {"node5", "120.27.26.78"},
    {"node6", "120.27.26.17"}
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ROCK WORLD BI is probably already running."), addrBind.ToString().c_str());
        else
